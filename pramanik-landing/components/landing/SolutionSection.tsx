  ...
  return (
    <section id="how" className="section" style={{ backgroundColor: '#FAF8F4', borderBottom: '1px solid #E8E0D5' }}>
      <div className="container">
        ...
        {/* Header */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '48px', marginBottom: '80px', alignItems: 'end' }} className="two-col">
          <div>
          ...
          <div>
            <p style={{ fontSize: '17px', color: '#555', lineHeight: 1.8 }}>
              We don't decide who is right. We read what actually happened — from government databases, satellite records, weather archives — and we let the facts decide. pramanik is a truth machine, not a judge.
            </p>
          </div>
        </div>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <div style={{ position: 'absolute', left: '28px', top: '40px', bottom: '40px', width: '1px', backgroundColor: '#E8E0D5' }} className="hide-mobile" />

          <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            {steps.map((step, i) => (
              <div key={step.num} style={{
                display: 'grid', gridTemplateColumns: '1fr',
                gap: '24px', paddingBottom: '60px',
              }} className="step-row">
                <div style={{ display: 'flex', gap: '32px', alignItems: 'flex-start' }}>
                  ...
                  <div style={{
                    ...
                    <span style={{ fontFamily: "'Playfair Display', serif", fontSize: '16px', fontWeight: 700, color: '#FAF8F4' }}>{step.num}</span>
                  </div>
                  {/* Content */}
                  <div style={{ paddingTop: '12px' }}>
                    <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(20px, 2.5vw, 26px)', fontWeight: 700, color: '#111', marginBottom: '14px' }}>
                      {step.title}
                    </h3>
        ...
        <div className="two-col" style={{ marginTop: '20px', paddingTop: '80px', borderTop: '1px solid #E8E0D5' }}>
          ...
          <div>
            ...
            <div className="divider" />
            <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(26px, 3vw, 38px)', fontWeight: 700, color: '#111', marginBottom: '20px' }}>
              Trade with confidence.<br />Get paid on time.
            </h3>
            <p style={{ fontSize: '16px', color: '#555', lineHeight: 1.8, marginBottom: '32px' }}>
              pramanik gives small exporters the same protection that large corporations have always had — but without the legal teams, the costs, or the waiting. Just ship, verify, get paid.
            </p>
            <Link href="/dashboard" style={{
              display: 'inline-block', backgroundColor: '#111', color: '#FAF8F4',
